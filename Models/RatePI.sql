...
USE `mydb`;
INSERT INTO `mydb`.`ASISTENTES` (`idAsistente`, `Email`, `NombreProyect`, `Categoria`, `Puntuacion`, `idProyecto_fk`) VALUES (1, 'algo@email', 'pro1', "implementacion", 2, 1);
INSERT INTO `mydb`.`ASISTENTES` (`idAsistente`, `Email`, `NombreProyect`, `Categoria`, `Puntuacion`, `idProyecto_fk`) VALUES (2, 'algo@email', 'pro1', "creatividad", 2, 1);
INSERT INTO `mydb`.`ASISTENTES` (`idAsistente`, `Email`, `NombreProyect`, `Categoria`, `Puntuacion`, `idProyecto_fk`) VALUES (3, 'algo@email', 'pro1', "comunicacion", 2, 1);
INSERT INTO `mydb`.`ASISTENTES` (`idAsistente`, `Email`, `NombreProyect`, `Categoria`, `Puntuacion`, `idProyecto_fk`) VALUES (4, 'me@email', 'pro2', "implementacion",5, 2);
INSERT INTO `mydb`.`ASISTENTES` (`idAsistente`, `Email`, `NombreProyect`, `Categoria`, `Puntuacion`, `idProyecto_fk`) VALUES (5, 'me@email', 'pro2', "creatividad",5, 2);
INSERT INTO `mydb`.`ASISTENTES` (`idAsistente`, `Email`, `NombreProyect`, `Categoria`, `Puntuacion`, `idProyecto_fk`) VALUES (6, 'me@email', 'pro2', "comunicacion",5, 2);
...
INSERT INTO `mydb`.`CATEGORIAS` (`idCategoria`, `idProyecto_fk`, `Categoria`, `PuntuacionTotal`, `Proyecto`) VALUES (4, 2, 'creatividad', 5, 'pro2');
INSERT INTO `mydb`.`CATEGORIAS` (`idCategoria`, `idProyecto_fk`, `Categoria`, `PuntuacionTotal`, `Proyecto`) VALUES (5, 2, 'implementacion', 5, 'pro2');
INSERT INTO `mydb`.`CATEGORIAS` (`idCategoria`, `idProyecto_fk`, `Categoria`, `PuntuacionTotal`, `Proyecto`) VALUES (6, 2, 'comunicacion', 5, 'pro2');
